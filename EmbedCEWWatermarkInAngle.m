function [WatermarkedValue,EmbedWatermarkRecord] = EmbedCEWWatermarkInAngle(fileID,OriginalValue, EncryptStepLength, WatermarkStepLength,WatermarkSequence,WatermarkLength,EmbedWatermarkRecord)
